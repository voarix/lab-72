...
const AdminDishItem: React.FC<Props> = ({dish, deleteLoading, onDeleteClick}) => {
  return (
      ...
      <div className="row">
        ...
        <div className="col-8 p-3 d-flex flex-column justify-content-between">
          ...
          <div className="mt-2">
            ...
            >
              Edit {deleteLoading && deleteLoading === dish.id && <ButtonSpinner/>}
            </Link>
            <button
              className="btn btn-danger"
              onClick={onDeleteClick}>
              Delete {deleteLoading && deleteLoading === dish.id && <ButtonSpinner/>}
            </button>
          </div>
        </div>
      </div>
